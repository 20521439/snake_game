...
public:
    struct Point A[800];
    struct Point Moi;
    int DoDai, DoKho, Level, LevelUnlocked, DieStatus, Language, MauMoi;
    char LastDirection;
    GAME() {
        DoKho = 2; LevelUnlocked = 1; MauMoi = 1;
            ...
            do {
                ...
                for (int i = 2; i < 9; i++) {
                    if (i <= LevelUnlocked) printf("%d.Man choi %d.", i, i);
                        ...
                        printf("%d.Man choi %d. DA KHOA! ", i, i);
...
>>>>>>> 078f0a6b070ede682470e93a528730f5cb1e237a
